...
## Project Structure
    ...
    ├── webdeleteapptest_de_24832  # Django project configurations
...
1. Clone this repo and `cd webdeleteapptest_de_24832`
...
2. Clone this repo and `cd webdeleteapptest_de_24832`
